<section class="mx-auto flex max-w-[980px] flex-col items-center gap-2 pt-8 pb-2 md:pt-12 lg:pt-24">
	<a
		href="https://github.com/ubemacapuno/open-ai-playground"
		...
		<svg
			...
			class="lucide-icon lucide lucide-arrow-right ml-1 size-4"
	...
	<p class="text-center text-sm text-orange-700 dark:text-orange-400">
		This application uses <a
			...
			target="_blank"
			rel="noreferrer"
			class="font-medium underline underline-offset-4">OpenAI API</a
		>,
		<a
			href="https://github.com/kovacsv/occt-import-js"
			target="_blank"
			rel="noreferrer"
			class="font-medium underline underline-offset-4">occt-import-js</a
		>, and
		<a
